...
{
    uint8_t WhichRow;
    for (WhichRow = 0; WhichRow < NUM_ROWS_IN_FONT; WhichRow++)// Your code to loop for every row in the character font
    {
